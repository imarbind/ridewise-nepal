    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <div className="space-y-3">
          ...
          {(trip.expenses || []).map(e => {
            const isAutoGenerated = e.item.startsWith('Fuel (') || e.item.startsWith('Service:');
            return (
          ...
          {(!trip.expenses || trip.expenses.length === 0) && <p className="text-center text-xs text-slate-400 py-4 italic">No expenses logged yet.</p>}
        </div>
      </div>
    </div>
  );
