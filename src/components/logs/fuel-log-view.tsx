...
export function FuelLogView({ logs }: FuelLogViewProps) {
    return (
            ...
            <div className="space-y-3">
                ...
                {logs.map((l, idx) => (
                    <div 
                        ...
                        className="bg-card border border-slate-200 p-4 rounded-2xl flex justify-between items-center shadow-md animate-in slide-in-from-bottom-2 fill-mode-backwards"
                    >
